    ...
    <body>
        <div class="body">
            ...
            <div class="column last">
                <object data=http://remax.idxhome.com/homesearch/59157 width="100%" height="100%"> <embed src=http://remax.idxhome.com/homesearch/59157 > </embed> Error: Embedded data could not be displayed. </object>
            </div>
        </div>
    </body>
</html>