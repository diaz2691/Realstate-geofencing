               ...
               <!--  
                ...
                <select id="agentName" onchange="getLicense()">
                    <?php
                        ...
                        echo "Gross Commission: <input type='number' id='commission' name='commission' min='349'><br/>";
                        ...
                        echo "</select>";
                        echo "<br/><br/>";
                        echo "Agent Percentage: <input type='number' id='percent' step='0.01' min=0>";
                    ?>
                    <br/>
                    <br/>
                    <input type="button" value="enter" id="button">
        ...
        <script>
            ...
            $("#button").click( function(event){
                ...
                $.ajax({
                    ...
                    {
                        console.log(data);
                        window.location.href = "viewLoanSheet.php";
                    }
                });
